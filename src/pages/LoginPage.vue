      ...
      <div class="col gt-sm">
        <q-img alt="login image" src="~assets/login-img.png" class="fit">
          <div class="absolute-top bg-transparent">
            <q-item-section>
              <q-img class="" alt="Propfunds.ng Logo" src="~assets/logo/Six_Star_3.png"
      ...
      <div class="col">
        <div class="column full-height">
          <div class="col-2 q-pb-xl q-pt-xl q-pl-md">
            <q-img class="lt-md" alt="Propfunds.ng Logo" src="~assets/logo/Six_Star_3.png" style="max-width: 200px; " />
          </div>
          <div class="col-10 ">
            <div class="login">
              <q-card class="my-card text-white" style="max-width: 400px">
                <q-card-section>
                  ...
                  <div class="text-6 q-pl-md q-pr-md q-pt-sm q-pb-sm text-primary">
                    Welcome to Six-Stars. let’s access
                    your account.
                  </div>
                </q-card-section>
                <q-card-section>
