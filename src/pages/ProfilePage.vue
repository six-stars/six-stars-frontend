      ...
      <!-- <q-form @submit="onSubmit" @reset="onReset"> -->
        <div class="row q-pt-sm">
          <div class="col-12 col-md-6 q-pl-md">
            <q-input readonly hint="First Name" class="" outlined :label="data.first_name"/>
          </div>
          <div class="col-12 col-md-6 q-pl-md">
        <q-input readonly hint="Last Name" class="" outlined :label="data.last_name" />
          </div>
        </div>
        <div class="row q-pt-sm">
          <div class="col-12 col-md-6 q-pl-md">
          ...
          <div class="col-12 col-md-6 q-pl-md">
            <q-input readonly hint="Phone Number" class="" outlined :label="data.phone_number" />
          </div>
        </div>
        <div class="row q-pt-sm">
          <div class="col-12 col-md-6 q-pl-md">
            <q-input readonly hint="User Type" class="" outlined :label="data.user_type" />
          </div>
          <div class="col-12 col-md-6 q-pl-md">
          ...
          <div class="col-12 col-md-6 q-pl-md">
            <div class="column">
              ...
              <div class="col q-pt-xs">
                <q-input readonly hint="Date Of Birth" class="" outlined :label="data.dob" />
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 q-pl-md">
