    ...
    <div class="q-pa-md row items-start q-gutter-md">
        <q-card class="my-card" v-for="user in data" :key="user.id">
          <q-card-section class="bg-primary text-white">
            <div class="text-h6 text-center">{{ user.first_name }} {{ user.last_name }}</div>
            <div>
              <div class="text-subtitle2">
                <q-icon name="fa-solid fa-person" class="q-pl-sm" color="white" />
                User ID:
                {{ user.user_id }}
              </div>
            </div>
            ...
            <div>
              <div class="text-subtitle2">
                <q-icon name="fa-solid fa-phone" class="q-pl-sm" color="white" />
                Phone:
                {{ user.phone_number }}
              </div>
            </div>
            ...
            <q-card style="width: 700px; max-width: 80vw;">
              ...
              <q-card-actions align="right">
                <div class="q-mr-sm">
                  ...
                  <q-btn flat label="Copy Phone Number" @click="copyTo(selectedCustomerPopup1.phone_number)" class="text-white" color="blue"
                    v-close-popup />
                </div>
              </q-card-actions>
            </q-card>
