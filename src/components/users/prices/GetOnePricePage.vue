        ...
        <q-card class="my-card-2 bg-primary text-white">
          <q-card-section>
            ...
            <div class="row q-pt-sm">
              ...
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Male Native 2Pcs Hanging
                </div>
            ...
            <div class="row q-pt-sm">
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Male Native 3Pcs Not-Agbada
                </div>
                <div class="text-h6">
                  ₦{{ data.male_native_3_pcs_notAgbada }}
                </div>
              </div>
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Male Native 3Pcs Not-Agbada Hanging
                </div>
                <div class="text-h6">
                  ₦{{ data.male_native_3_pcs_notAgbada_hanging }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
            ...
            <div class="row q-pt-sm">
              ...
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Female Trouser Jeans Hanging
                </div>
                <div class="text-h6">
                  ₦{{ data.female_trouser_jeans_hanging }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Skirt And Blouse English
                </div>
                <div class="text-h6">₦{{ data.skirt_and_blouse_english }}</div>
              </div>
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Skirt And Blouse English Hanging
                </div>
                <div class="text-h6">
                  ₦{{ data.skirt_and_blouse_english_hanging }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
              ...
              <div class="col-12 col-md-6 q-pl-md">
                ...
                <div class="text-h6">
                  ₦{{ data.female_native_buba_trouser }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
            ...
            <div class="row q-pt-sm">
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Skirt And Blouse Native
                </div>
                <div class="text-h6">₦{{ data.skirt_and_blouse_native }}</div>
              </div>
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Aso-Oke Wrapper Buba Or Gele
                </div>
            ...
            <div class="row q-pt-sm">
              ...
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Male Medium T-Shirt Or Polo
                </div>
                <div class="text-h6">
                  ₦{{ data.male_medium_t_shirt_or_polo }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Male Big T-Shirt Or Polo
                </div>
                <div class="text-h6">₦{{ data.male_big_t_shirt_or_polo }}</div>
              </div>
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Male T-Shirt Or Polo Hanging
                </div>
                <div class="text-h6">
                  ₦{{ data.male_t_shirt_or_polo_hanging }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
            ...
            <div class="row q-pt-sm">
              ...
              <div class="col-12 col-md-6 q-pl-md">
                ...
                <div class="text-h6">
                  ₦{{ data.jeans_chinos_trouser_hanging }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
            ...
            <div class="row q-pt-sm">
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Male Two Piece Suit Hanging
                </div>
                <div class="text-h6">₦{{ data.male_two_pcs_suit_hanging }}</div>
              </div>
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Male Three Piece Suit Hanging
                </div>
                <div class="text-h6">
                  ₦{{ data.male_three_pcs_suit_hanging }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Female Two Piece Suit Hanging
                </div>
                <div class="text-h6">
                  ₦{{ data.female_two_pcs_suit_hanging }}
                </div>
              </div>
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Female Three Piece Suit Hanging
                </div>
                <div class="text-h6">
                  ₦{{ data.female_three_pcs_suit_hanging }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
            ...
            <div class="row q-pt-sm">
              ...
              <div class="col-12 col-md-6 q-pl-md">
                <div class="text-subtitle2 bg-grey">
                  Small Weeding Gown Hanging
                </div>
                <div class="text-h6">
                  ₦{{ data.small_wedding_gown_hanging }}
                </div>
              </div>
            </div>
            <div class="row q-pt-sm">
