        ...
        <div class="q-pa-md row items-start q-gutter-md" v-if="fixed0">
          <q-card class="my-card-2 bg-primary text-white">
            ...
            <q-card-actions align="right">
              <q-btn @click="goToCreateIntake(data.first_name, data.last_name, data.phone1)" flat>Create Intake</q-btn>
            </q-card-actions>
          </q-card>
        </div>
    </div>
...
const goToCreateIntake = (first_name, last_name, phone) => {
  $router.push({ name: 'CreateIntakesPage', params: { first: first_name, last: last_name, phone: phone } })
}
...
const onSubmit = () => {
  ...
  axios.get(`${base}/customer/${phone1.value}`,
